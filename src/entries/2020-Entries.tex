...
\begin{description}
    ...
    \item[1000] Water is up to temp.  Re-gapped mill to .035 using a feeler gauge, and milled the grains.  Added one scoop of 
    \item[1040] Started Mash in
    \item[1050] Mash in Complete inserted the train bar. Temp is 120
    \item[1124] Raised temperate in mash tube to 150.  Started recirculating. The overflow bypass filled very quickly, but it does seem to be holding the water at a level flush with it's top.  Using it seems to help, but it is not a full proof prevention of overflow, it just allows a bit more buffer space on the flow setting of the recirculation.  Recirculation still has to be very slow.
    \item[1135] We have reached 150, restarting one hour timer from here.
    \item[1235] Raised mash tube up. Starged sparging, targeting 8.0L of water for sparging over approximately an hour.  Setting temperature of kettle to 185.
    \item[1320] 8.0 Liters completed sparging, letting wort finish draining from grain bed for remaining hour.
    \item[1335] Set the kettle temperature to 220 to bring the wort to a boil.
    \item[1355] Removed grain bed at 214 degrees, boil started, wort level is at the 5.0 gal mark on the mash tun. 1.034
    \item[1410] Added 1.5 oz German Hersbrucker Hops 1.8\% in hop spider.  Started Timer for 55 minutes.
    \item[1505] Added 1 teaspoon irish moss and .5 oz  German Hersbrucker Hops 1.8\% in hop spider
    \item[1515] Started circulating through the plate chiller to sanitize everything for remaining 5 minutes.  Heat is on full.
    \item[1520] Boil Complete.  Trasfer to primary fermentation bucket with yeast at 64 degrees.
