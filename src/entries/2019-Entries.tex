...
\textbf{Note:} Sparge heater set to 80 for sparging, set to 65 for warming cleaning water.
...
\begin{description}
    \item[0710] Start 4.5 Gallon in mash tun at 160
    \item[0750] Reached Temp
    \item[0810] Set mash tun to 154 deg, started Mash In
    \item[0820] Mash in complete temp at 148
    \item[0920] Raised temperature setting to 168
    \item[0930] Raised mash tube, Closed valve on the mash tun and opened the valve on the sparge water heater.  Targeting 11L of sparge water.
    \item[1026] 10L of sparge water transferred, turned off pump and closed the valve on the sparge water.  Set the mash tun temperature to 220.
    \item[1100] While heating up to boiling, another 5L of water was added to adjust the gravity the refractometer read 1.048 
    \item[1110] Boil Started
    \item[1250] Begin Transfer
    \item[1330] Start 4.5 Gallon in mash tun at 161
    \item[1400] Reached Temp
    \item[1415] Set mash tun to 154 deg, started Mash In
    \item[1420] Mash in complete temp at 154
    \item[1520] Raised temperature setting to 168
    \item[1530] Raised mash tube, Closed valve on the mash tun and opened the valve on the sparge water heater.  Targeting 11L of sparge water.
    \item[1620] 11L of sparge water transferred, turned off pump and closed the valve on the sparge water.  Set the mash tun temperature to 220.
    \item[1647] Boil Started SG 1.041
